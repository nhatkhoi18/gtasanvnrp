...
public class GameNative {
    ...
    static {
        ...
        // VN-RP: libsamp is loaded by SAMP after the GTA activity/native runtime
        // has completed its base onCreate path. Loading hooks here is too early
        // and can kill the process immediately when Play is pressed.
    }
